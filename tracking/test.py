...
def main():
    ...
    parser.add_argument('tracker_name',default='MSTL' ,type=str, help='Name of tracking method.')
    parser.add_argument('tracker_param', default='MSTL',type=str, help='Name of config file.')
