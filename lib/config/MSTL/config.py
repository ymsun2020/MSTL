...
cfg.MODEL.TRANSFORMER.DEC_LAYERS = 0
cfg.MODEL.TRANSFORMER.PRE_NORM = False
cfg.MODEL.TRANSFORMER.DIVIDE_NORM = False

#FS
cfg.MODEL.FS_TEMP= edict()
cfg.MODEL.FS_TEMP.DIM = 128
cfg.MODEL.FS_TEMP.NUM = 16

cfg.MODEL.FS_SCR = edict()
cfg.MODEL.FS_SCR.DIM = 128
cfg.MODEL.FS_SCR.NUM = 4
...
cfg.DATA.SEARCH.SAMPLE_INTERVAL = 5
cfg.DATA.SEARCH.DENSE = 1
cfg.DATA.SEARCH.SPARSE = 2
cfg.DATA.SEARCH.NUM =cfg.DATA.SEARCH.DENSE  + cfg.DATA.SEARCH.SPARSE
...
cfg.DATA.TEMPLATE.DENSE = 1
cfg.DATA.TEMPLATE.SPARSE = 1
cfg.DATA.TEMPLATE.NUM = cfg.DATA.TEMPLATE.DENSE + cfg.DATA.TEMPLATE.SPARSE
