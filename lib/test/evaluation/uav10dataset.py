...
class UAV10_Dataset(BaseDataset):
    """
    DTBDataset dataset.
    """
    def __init__(self):
        ...
        self.base_path = '/media/suixin/D/DataSet2/UAV10'
    ...
    def _get_sequence_info_list(self):
        """seq name"""
        name_list = os.listdir(self.base_path + '/data_seq' )
        sequence_info_list = []
        """get ground_truth and img path"""
        for seq_name in name_list:
            img_path =   'data_seq/'+seq_name
            anno_path =  'anno/' +  seq_name + '.txt'
