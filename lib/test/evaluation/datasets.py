...
dataset_dict = dict(
    ...
    uav10=DatasetInfo(module=pt % "uav10", class_name="UAV10_Dataset", kwargs=dict()),
    uavl=DatasetInfo(module=pt % "uavL", class_name="UAVL_Dataset", kwargs=dict()),
    uavdt = DatasetInfo(module=pt % "uavdt", class_name="UAVDT_Dataset", kwargs=dict()),
    uavd = DatasetInfo(module=pt % "uavd", class_name="UAVd_Dataset", kwargs=dict())
)
