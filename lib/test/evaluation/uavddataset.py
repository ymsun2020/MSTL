...
class UAVd_Dataset(BaseDataset):
    """ UAV123 dataset.
    Publication:
    ...
    def __init__(self):
        ...
        self.txt_path = '/media/suixin/D/DataSet2/UAV_downsample/1_linear/'
        # self.txt_path = '/media/suixin/D/DataSet2/UAV_downsample/25_random/'
    ...
    def _construct_sequence(self, sequence_info):
        ...
        seq_name = anno_path.split('/')[-1]
        frame_file = open(   self.txt_path + 'frame/' + seq_name  + '.txt', 'r')
        print( seq_name  )
        _frames =    frame_file.readlines()
        frames = [ path[:-1]  for path in _frames ]

        anno_path = self.txt_path + 'anno/' + seq_name  + '.txt'
